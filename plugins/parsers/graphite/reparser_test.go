...
var (
	re_templates = map[string][]string{
		...
		"push": {
			"(?P<hostname>^push\\w+?)\\.(?P<component>\\w+?-\\w+-(?P<name>\\w+_\\d+))\\.(?P<metric1>StoredQueue)\\.(?P<queue>.+?)\\.(?P<metric2>\\w+$) => ${metric1}.${metric2}",
			"(?P<hostname>^push\\w+?)\\.(?P<component>\\w+?-\\w+-(?P<name>\\w+_\\d+))\\.(?P<metric1>ClientOutMessageDlvStatusCounter)\\.(?P<status>[\\w]+?)\\.(?P<type>\\w+$) => ${metric1}",
			"(?P<hostname>^push\\w+?)\\.(?P<component>\\w+?-\\w+-(?P<name>\\w+_\\d+))\\.(?P<metric1>ConnectorOutMessageDlvStatusCounter)\\.(?P<status>[\\w]+?)\\.(?P<type>\\w+$) => ${metric1}",
			"(?P<hostname>^push\\w+?)\\.(?P<component>\\w+?-\\w+-(?P<name>\\w+_\\d+))\\.(?P<metric1>Transmitter.*?)\\.(?P<peer>([\\w-]+?(\\d+|demo))|sb)\\.(?P<metric2>(size|queueSize|consumerAvailable)$) => ${metric1}.${metric2}",
			"(?P<hostname>^push\\w+?)\\.(?P<component>\\w+?-\\w+-(?P<name>\\w+_\\d+))\\.(?P<metric1>Transmitter.*?)\\.(?P<peer>([\\w-]+?(\\d+|demo))|sb)\\.(?P<metric2>.+?)\\.(?P<type>\\w+$) => ${metric1}.${metric2}",
			"(?P<hostname>^push\\w+?)\\.(?P<component>\\w+?-\\w+-(?P<name>\\w+_\\d+))\\.(?P<metric1>In_message.+)\\.cnrId-(?P<cnrid>\\d+?)\\.acnId-(?P<acnid>\\d+)\\.(?P<type>\\w+$) => ${metric1}",
			"(?P<hostname>^push\\w+?)\\.(?P<component>\\w+?-\\w+-(?P<name>\\w+_\\d+))\\.(?P<metric1>.+Sender)\\.(?P<peer>[\\w-]+?\\d+)\\.(?P<metric2>.+?)\\.(?P<type>\\w+$) => ${metric1}.${metric2}",
			"(?P<hostname>^push\\w+?)\\.(?P<component>\\w+?-\\w+-(?P<name>\\w+_\\d+))\\.(?P<metric1>.+Sender)\\.(?P<peer>[\\w-]+?\\d+)\\.(?P<metric2>\\w+$) => ${metric1}.${metric2}",
			"(?P<hostname>^push\\w+?)\\.(?P<component>\\w+?-\\w+-(?P<name>\\w+_\\d+))\\.(?P<metric1>.+Processor)-(?P<peer>[\\w\\d-]+?)\\.(?P<metric2>(size|queueSize)$) => ${metric1}.${metric2}",
			"(?P<hostname>^push\\w+?)\\.(?P<component>\\w+?-\\w+-(?P<name>\\w+_\\d+))\\.(?P<metric1>.+Processor)-(?P<peer>[\\w\\d-]+?)\\.(?P<metric2>.+?)\\.(?P<type>\\w+$) => ${metric1}.${metric2}",
			"(?P<hostname>^push\\w+?)\\.(?P<component>\\w+?-\\w+-(?P<name>\\w+_\\d+))\\.(?P<metric1>.+?)\\.acnId-(?P<acnid>\\d+)\\.(?P<metric2>.+?)\\.(?P<type>\\w+$) => ${metric1}.${metric2}",
			"(?P<hostname>^push\\w+?)\\.(?P<component>\\w+?-\\w+-(?P<name>\\w+_\\d+))\\.(?P<metric1>(SmsDelivered|SmsUndelivered|TransmitToSmsPlatform|EnqueuedForSend|SmsSent|SmsCanceled|SmsDelayed|SmsFailed))\\.(?P<acncode>\\w+?)\\.(?P<cnrcode>\\w+?)\\.(?P<type>\\w+$) => ${metric1}",
			"(?P<hostname>^push\\w+?)\\.(?P<component>\\w+?-\\w+-(?P<name>\\w+_\\d+))\\.(?P<metric1>.+?)\\.(?P<metric2>(size|queueSize|.+TransmittersCount)$) => ${metric1}.${metric2}",
			"(?P<hostname>^push\\w+?)\\.(?P<component>\\w+?-\\w+-(?P<name>\\w+_\\d+))\\.(?P<metric1>.+?)\\.(?P<type>\\w+$) => ${metric1}",
			"(?P<hostname>^push\\w+?)\\.(?P<component>\\w+?-\\w+-(?P<name>\\w+_\\d+))\\.(?P<metric1>[\\w-]+$) => ${metric1}",
		},
		"advisa": {
			"(?P<hostname>^avi\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.(?P<midname>StoredQueue\\.Transmitter\\.[\\w\\.-]+?)\\.(?P<type>[\\w-]+$) => storedqueue.transmitter",
			"(?P<hostname>^avi\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.(?P<midname>StoredQueue\\.[\\w\\.-]+?)\\.(?P<type>[\\w-]+$) => storedqueue",
			"(?P<hostname>^avi\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.(?P<midname>Transmitter\\.[\\w\\.-]+?(Time|Timer|Override|Operations|Merchant|Terminal|DataSource|QueryExecution|OpeningConnection|Duration|Locations))\\.(?P<type>[\\w-]+$) => transmitter.timer",
			"(?P<hostname>^avi\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.(?P<midname>Transmitter\\.[\\w\\.-]+?(Count|Meter|Imports|Connections))\\.(?P<type>[\\w-]+$) => transmitter.counter",
			"(?P<hostname>^avi\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.(?P<midname>Transmitter\\.[\\w\\.-]+?)\\.(?P<type>[\\w-]+$) => transmitter",
			"(?P<hostname>^avi\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.(?P<midname>StoredMap\\.[\\w\\.-]+?)\\.(?P<type>[\\w-]+$) => storedmap",
			"(?P<hostname>^avi\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.(?P<midname>[\\w\\.-]+?(Count|Meter|Imports|Connections))\\.(?P<type>[\\w-]+$) => counter",
			"(?P<hostname>^avi\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.(?P<midname>[\\w\\.-]+?Bean)\\.(?P<type>[\\w-]+$) => bean",
			"(?P<hostname>^avi\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.(?P<midname>[\\w\\.-]*?(heap|non-heap|-Cache|-Space|-Gen|total))\\.(?P<type>[\\w-]+$) => memory",
			"(?P<hostname>^avi\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.(?P<midname>[\\w\\.-]+?(Time|Timer|Override|Operations|Merchant|Terminal|DataSource|QueryExecution|OpeningConnection|Duration|Locations))\\.(?P<type>[\\w-]+$) => timer",
			"(?P<hostname>^avi\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.(?P<midname>[\\w\\.-]+?Pool)\\.(?P<type>[\\w-]+$) => pool",
			"(?P<hostname>^avi\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.(?P<midname>[\\w\\.-]+IdCache?)\\.(?P<type>[\\w-]+$) => idcache",
			"(?P<hostname>^avi\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.(?P<midname>[\\w\\.-]+Cache?)\\.(?P<type>[\\w-]+$) => cache",
			"(?P<hostname>^avi\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.(?P<midname>[\\w\\.-]+?)\\.(?P<type>(queueSize|retryQueueSize)$) => queue",
			"(?P<hostname>^avi\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.(?P<midname>[\\w\\.-]+?)\\.(?P<type>notIndexedCount$) => value",
			"(?P<hostname>^avi\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.(?P<midname>[\\w\\.-]+?)\\.(?P<type>[\\w-]+Speed$) => speed",
			"(?P<hostname>^avi\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.uptime$ => uptime",
			//"(?P<hostname>^avi\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.(?P<metric1>.+$) => ${metric1}",
		},
	}
)
	...
	var tests = map[string][]struct {
		...
		"push": {
			...
			},
			{
				...
				tags:        map[string]string{"hostname": "pushsrv06", "component": "channel-push_gcmxmpp-prod_06", "name": "prod_06", "type": "committed"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushsrv01", "component": "channel-push_wns-prod_01", "name": "prod_01", "type": "m1"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushsrv08", "component": "connector-gate-sb_06", "name": "sb_06", "type": "mean", "peer": "channel-push_wp-prod_03"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushsrv08", "component": "connector-gate-sb_06", "name": "sb_06", "peer": "channel-push_gcmxmpp-prod_00"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushdemo00", "component": "connector-advisa-demo_00", "name": "demo_00", "type": "p99"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushdemo00", "component": "connector-advisa-demo_00", "name": "demo_00", "type": "mean"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushsrv07", "component": "channel-push_apnshttp-prod_07", "name": "prod_07", "type": "count", "peer": "ru_rsb_mobbank_334"},
			},
			{
				input:       "pushsrv08.connector-gate-sb_06.pools.Compressed-Class-Space.committed",
				measurement: "pools.Compressed-Class-Space",
				tags:        map[string]string{"hostname": "pushsrv08", "component": "connector-gate-sb_06", "name": "sb_06", "type": "committed"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushsrv05", "component": "connector-http-tcsbank_03", "name": "tcsbank_03", "type": "m1"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushsrv08", "component": "connector-gate-sb_06", "name": "sb_06", "type": "m1", "status": "delivered"},
			},
			{
				input:       "pushsrv07.channel-push_gcmxmpp-prod_07.pools.Metaspace.max",
				measurement: "pools.Metaspace",
				tags:        map[string]string{"hostname": "pushsrv07", "component": "channel-push_gcmxmpp-prod_07", "name": "prod_07", "type": "max"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushdemo00", "component": "channel-push_apnshttp-demo_00", "name": "demo_00", "type": "p95"},
			},
			{
				input:       "pushdemo00.channel-push_gcm-demo_00.StoredQueue.1035.size",
				measurement: "StoredQueue.size",
				tags:        map[string]string{"hostname": "pushdemo00", "component": "channel-push_gcm-demo_00", "name": "demo_00", "queue": "1035"},
			},
			{
			...
			},
			{
				...
				tags:        map[string]string{"hostname": "pushdemo00", "component": "connector-gate-sb_demo_01", "name": "sb_demo_01"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushdemo00", "component": "channel-push_gcm-demo_00", "name": "demo_00", "type": "count", "peer": "com_idamob_tinkoff_android_pro_1020"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushsrv08", "component": "connector-gate-sb_06", "name": "sb_06", "type": "count"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushdemo00", "component": "connector-http-brooma_demo_06", "name": "brooma_demo_06", "type": "m1", "status": "rejected"},
			},
			{
				...
				measurement: "StoredQueue.size",
				tags:        map[string]string{"hostname": "pushdemo00", "component": "channel-push_apnshttp-demo_00", "name": "demo_00", "queue": "Transmitter.CmiPushMessageDlvEvent.connector-http-tcsbankdemo_00"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushdemo00", "component": "connector-gate-sovcombankdemo_00", "name": "sovcombankdemo_00", "type": "errorPacketCount"}, //!!!
			},
			{
				...
				tags:        map[string]string{"hostname": "pushdemo00", "component": "connector-gate-bcsdemo_00", "name": "bcsdemo_00", "type": "p95"},
			},
			{
				input:       "pushdemo00.connector-gate-sbdemo_04.PlatformPacketListener.latestReceivedPacketTimestamp",
				measurement: "PlatformPacketListener",
				tags:        map[string]string{"hostname": "pushdemo00", "component": "connector-gate-sbdemo_04", "name": "sbdemo_04", "type": "latestReceivedPacketTimestamp"}, //!!!
			},
			{
				...
				tags:        map[string]string{"hostname": "pushdemo00", "component": "channel-push_apnshttp-demo_00", "name": "demo_00", "peer": "ru_sberbank_onlineiphone_beta_42"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushsrv05", "component": "channel-push_apnshttp-prod_05", "name": "prod_05", "peer": "com_brooma_threads-beta_377", "type": "m1"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushdemo00", "component": "connector-gate-openbankdemo_00", "name": "openbankdemo_00"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushsrv03", "component": "channel-sms_hpx-prod_01", "name": "prod_01", "peer": "psbank", "type": "m1"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushsrv00", "component": "server-web_push-prod_00", "name": "prod_00", "peer": "sb", "type": "p99"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushdemo00", "component": "connector-gate-vtb24demo_02", "name": "vtb24demo_02", "peer": "vtb24", "type": "p999"},
			},
			{
				input:       "pushdemo00.channel-sms_hpx-demo_00.SmsCanceled.Sb.Base.count",
				measurement: "SmsCanceled",
				tags:        map[string]string{"hostname": "pushdemo00", "component": "channel-sms_hpx-demo_00", "name": "demo_00", "acncode": "Sb", "cnrcode": "Base", "type": "count"},
			},
			{
				input:       "pushsrv03.channel-sms_hpx-prod_01.HpxChannelProcessor-psbank.queueSize",
				measurement: "HpxChannelProcessor.queueSize",
				tags:        map[string]string{"hostname": "pushsrv03", "component": "channel-sms_hpx-prod_01", "name": "prod_01", "peer": "psbank"},
			},
			{
				input:       "pushsrv03.connector-http-brooma_13.In_message_confirm.cnrId-131.acnId-17.count",
				measurement: "In_message_confirm",
				tags:        map[string]string{"hostname": "pushsrv03", "component": "connector-http-brooma_13", "name": "brooma_13", "cnrid": "131", "acnid": "17", "type": "count"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushdemo00", "component": "server-web_push-demo_00", "name": "demo_00", "type": "count"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushdemo00", "component": "server-web_push-demo_00", "name": "demo_00", "acnid": "10", "type": "m1"},
			},
			{
				input:       "pushsrv01.channel-sms_hpx-prod_00.SmsUndelivered.Sovcombank.Rosban.m1",
				measurement: "SmsUndelivered",
				tags:        map[string]string{"hostname": "pushsrv01", "component": "channel-sms_hpx-prod_00", "name": "prod_00", "acncode": "Sovcombank", "cnrcode": "Rosban", "type": "m1"},
			},
			{
				input:       "pushsrv06.channel-sms_hpx-prod_02.StoredQueue.HpxChannel-vtb24-queue.size",
				measurement: "StoredQueue.size",
				tags:        map[string]string{"hostname": "pushsrv06", "component": "channel-sms_hpx-prod_02", "name": "prod_02", "queue": "HpxChannel-vtb24-queue"},
			},
			{
				...
				measurement: "StoredQueue.size",
				tags:        map[string]string{"hostname": "pushsrv05", "component": "channel-push_gcmxmpp-prod_05", "name": "prod_05", "queue": "Transmitter.CmiPushMessageDlvEvent.connector-http-brooma_01"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushsrv00", "component": "connector-http-brooma_12", "name": "brooma_12", "type": "count"},
			},
			{
			...
			},
			{
				...
				tags:        map[string]string{"hostname": "pushdemo00", "component": "channel-sms_hpx-demo_00", "name": "demo_00", "peer": "connector-http-tcsbank_02", "type": "mean"},
			},
			{
				input:       "pushdemo00.channel-sms_hpx-demo_00.Transmitter.CmiSmsMessageDlvEvent.connector-db-test_demo.enqueueTimer.mean",
				measurement: "Transmitter.CmiSmsMessageDlvEvent.enqueueTimer",
				tags:        map[string]string{"hostname": "pushdemo00", "component": "channel-sms_hpx-demo_00", "name": "demo_00", "peer": "connector-db-test_demo", "type": "mean"},
			},
			{
				...
				tags:        map[string]string{"hostname": "pushdemo00", "component": "server-web_push-demo_00", "name": "demo_00", "peer": "connector-http-broomademo_08"},
			},
		},
		"advisa": {
			{
