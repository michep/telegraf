...
var (
	re_templates = map[string][]string{
		...
		"push": {
			...
			"(?P<hostname>^push\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.(?P<metric1>Transmitter.*?)\\.(?P<peer>[\\w-]+?(\\d+|demo))\\.(?P<metric2>(size|queueSize)$) => ${metric1}.${metric2}",
			"(?P<hostname>^push\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.(?P<metric1>Transmitter.*?)\\.(?P<peer>[\\w-]+?(\\d+|demo))\\.(?P<metric2>.+?)\\.(?P<type>\\w+$) => ${metric1}.${metric2}",
			...
			"(?P<hostname>^push\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.(?P<metric1>(SmsDelivered|SmsUndelivered|TransmitToSmsPlatform|EnqueuedForSend))\\.(?P<acncode>\\w+?)\\.(?P<cnrcode>\\w+?)\\.(?P<type>\\w+$) => ${metric1}",
			...
			//"(?P<hostname>^push\\w+?)\\.(?P<component>[\\w-]+?\\d+)\\.(?P<metric1>.+MessageDlvEvent)\\.(?P<peer>[\\w-]+?)\\.(?P<metric2>.+?)\\.(?P<type>\\w+$) => ${metric1}.${metric2}",
		},
		"advisa": {
